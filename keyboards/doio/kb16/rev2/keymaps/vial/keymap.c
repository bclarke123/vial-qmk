...
<<<<<<<< HEAD:keyboards/doio/kb16/rev2/keymaps/via/keymap.c
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
========
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
>>>>>>>> e2addc29d7 (Add vial support for rev2 from https://github.com/thompson-vii/kb16_rev2_vial_fw):keyboards/doio/kb16/rev2/keymaps/vial/keymap.c
